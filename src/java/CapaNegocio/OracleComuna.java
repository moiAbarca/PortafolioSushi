 ...
 * @author moi
 */
public class OracleComuna implements ComunaDao{
    ...
    public List<Comuna> obtenerComuna() throws SQLException {
        ...
        try
        {
            ...
            sql = "{call FUKUSUKESUSHI.LISTAR_COMUNA(?)}";
    ...
    public void modificarComuna(Comuna comuna) throws SQLException {
        ...
        {            
            ...
            sql = "{call FUKUSUKESUSHI.COMUNA_tapi.upd(?, ?, ?)}";
            cs = con.prepareCall(sql);
            cs.setString(1, comuna.getComunaNombre());
            cs.setInt(2, comuna.getComunaId());
    ...
    public void eliminarComuna(Integer id) throws SQLException {
        ...
        {            
            ...
            sql = "{call FUKUSUKESUSHI.COMUNA_tapi.del(?)}";
            cs = con.prepareCall(sql);
    ...
    public Comuna buscarComuna(Integer id) throws SQLException {
        ...
        try
        {
            ...
            sql = ("{call FUKUSUKESUSHI.BUSCAR_COMUNA(?,?)}");            
            cs = con.prepareCall(sql);
